<?php
  ...
  /*
    A class for creating remote connection to the processing server. This takes arguments from the configs to create and
    authenticate the connection before it is ready to be used. the output is $this->res, a variable that will either
    be a SSH2 session object if all of the stages are passed, or a JSON structure string variable that details which
